...
<center>
  <fieldset>
<LEGEND><u>Enter Competition Details</u> </LEGEND>
...
<tr>
    <td>Conducted By</td>
    <td><input type="text" name="cond_by" placeholder="Eg: KJSCE" required></td>
  </tr>
<tr>
    <td>Position:</td>
...
<tr>
    ...
    <td><input  id="certi" type="file" name="certi" required></td>
  </tr>
</table>
<br><br>    
...
<ul>
  <li>
    <a href="#">
      ...
      <p>Note : The certificate file name should be saved as srno_rollno. eg: Your first competition certificate filename will be 1_<?php 
