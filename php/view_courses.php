...
<table style="margin-top:40px" border="3" solid white>
        ...
        <tr><th>  <span style='color:#AFA;'> Roll No.</th><th>Name</th><th>Institute/Website</th><th>Start date</th><th>End date</th><th>Certificate</th> </span></tr>
<?php
...
{
  echo "<center><style='margin: 1000px 5px 15px 20px'><font size='5'> NO ENTRIES FOUND </font></style></center>";
}
$conn->close();
?>
