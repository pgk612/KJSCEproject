...
<center>
  <fieldset>
<legend><u>Enter TPP Details</u> </legend>

 <form action="php/ins_tpp.php" method="POST"  enctype="multipart/form-data">
<table>
...
<tr>
    <td>Presented At:</td>
    <td><textarea cols="30" rows="10" name="presented_at" placeholder="Eg: Oxford University" style="color:white" required></textarea></td>
  </tr>
    <td>Attach Paper:</td>
...
<ul>
  <li>
    <a href="#">
      ...
      <p>Note : The certificate file name should be saved as srno_rollno. eg: Your first tpp  filename will be 1_<?php 
