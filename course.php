...
<center>
  <fieldset>
 <legend><u>Enter Course Details</u></legend>

  <form action="php/ins_courses.php" method="POST"  enctype="multipart/form-data">
<table>
...
<ul>
  <li>
    <a href="#">
      ...
      <p>Note : The certificate file name should be saved as srno_rollno. eg: Your first course certificate filename will be 1_<?php 
