...
document.getElementById ("pos").value = data.value;
...
<center>
  <fieldset>
 <legend><u>Enter Sports Details</u></legend>

   <form action="php/ins_sports.php" method="POST"  enctype="multipart/form-data">
<table>
  ...
  <tr>
    ...
    <td><input type="text" name="tour_name" placeholder="Eg: Skream" required></td>
  </tr>
<tr>
    <td>Place:</td>
    <td><input type="text" name="place" placeholder="Eg: KJSCE,Mumbai" required></td>
  </tr>
<tr>
    <td>Position:</td>
    <td>
      <input type="text" id="pos" name="position" required>

<select id="pos1" onchange="ChoosePosition(this)" name="position" value="Participant" required>
