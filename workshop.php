...
<center>
<u><h2>Enter Workshop/Seminar Details</h2></u>

  <form action="php/ins_workshop.php" method="POST">
<table>
  ...
  <tr>
    ...
    <td><input type="text" name="namew" placeholder="Eg: Arduino Workshop" required></td>
  </tr>
<tr>
    <td>Conducted By:</td>
    <td><input type="text" name="con_by" placeholder="Eg: KJSCE" required></td>
  </tr>
<tr>
    <td>Start Date:</td>
